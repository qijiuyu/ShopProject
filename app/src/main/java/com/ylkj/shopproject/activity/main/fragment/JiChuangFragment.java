 ...
 * 机床列表
 */
public class JiChuangFragment extends BaseFragment implements MyRefreshLayoutListener {
            ...
            if(null==searchResultAdapter){
                searchResultAdapter=new SearchResultAdapter(mActivity,listAll,new SearchResultAdapter.OnItemClickListener(){
                    public void onItemClick(int position) {
                        ...
                        Intent intent=new Intent(mActivity,JCDetailsActivity.class);
    ...
    public void onRefresh(View view) {
        page=1;
        HttpMethod.searchGoods(1, SearchResultActivity.keys,page,HandlerConstant.SEARCH_GOODS_SUCCESS1,handler);
    }

    @Override
    public void onLoadMore(View view) {
        page++;
        HttpMethod.searchGoods(1, SearchResultActivity.keys,page,HandlerConstant.SEARCH_GOODS_SUCCESS2,handler);
    }
