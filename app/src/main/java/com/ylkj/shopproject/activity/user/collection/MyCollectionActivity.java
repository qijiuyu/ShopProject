package com.ylkj.shopproject.activity.user.collection;
...
import com.ylkj.shopproject.activity.user.fragment.MyCollectionFragment;
...
public class MyCollectionActivity extends BaseActivity {
    ...
    private ViewPagerCallBack viewPagerCallBack=new ViewPagerCallBack() {
        public void PageSelected(int position) {
            MyCollectionActivity.index=position;
        }
