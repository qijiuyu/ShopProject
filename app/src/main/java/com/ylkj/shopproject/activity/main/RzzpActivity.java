...
import com.ylkj.shopproject.activity.user.setting.AboutActivity;
 ...
 * 融资租赁
 */
public class RzzpActivity extends BaseActivity {
    private TextView tvTitle,tvContent;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rzzl);
        initView();
        about();
    }
